...
import {COURSES,sequence,assess,validNickname,randomProblem,courseSteps,formatKST,rankingCondition,bindPressInput,bindHubShare} from './core.mjs?v=20260911-arithmetic3';
